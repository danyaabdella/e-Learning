...
export default async function handler(req, res) {
  ...
  if (req.query.userId) {
    ...
    // If no userId in query, proceed to check the Authorization header for the token
  ...
  switch (method) {
    case 'GET':
      try {
        // If `userId` is provided in the query params, use that; otherwise, use the one from the token
